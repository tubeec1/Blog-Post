...
const ContactUs = () => {
  return (
    <div className="py-10 px-6  bg-gray-50 py-10">
      <div className=" grid grid-cols-2 gap-10 max-w-[1200px] mx-auto bg-white shadow-md p-10 rounded-xl">
        <div>
          ...
          <p className="text-gray-400">
            ...
            here to help. Feel free to reach out to us anytime,
          </p>
