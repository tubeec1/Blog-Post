...
const CategoryHeader = ({ showForm, setShowForm, selectedCategory }) => {
        ...
        <div className="fixed inset-0 bg-[rgba(0,0,0,0.7)] z-50">
          <div className="w-[50%] h-fit bg-white text-black mx-auto mt-20 py-10 px-10 rounded">
            <div className="flex justify-between py-2 mb-5">
              <h1 className="text-3xl font-bold text-center"> Category Registrasion</h1>

              <button className='text-3xl cursor-pointer hover:text-pink-500' onClick={() => setShowForm(false)}>X</button>
            </div>
